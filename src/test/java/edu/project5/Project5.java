...
public class Project5 {
    ...
    private MethodHandle getNameHandler;
    ...
    public void setup() throws Throwable {
        student = new Student("Artem", "Evseev");
        ...
        getNameHandler = lookup.findVirtual(Student.class, "name", MethodType.methodType(String.class));
    ...
    public void methodHandles(Blackhole bh) throws Throwable {
        bh.consume(getNameHandler.invoke(student));
    }
